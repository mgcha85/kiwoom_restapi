...
def get_stockList(db_url: str):
    ...
    df.to_sql("stockList", con, index=False, if_exists='replace')

def get_trade_amount(start_date, end_date):
    con = sqlite3.connect('sqlite3/trade_amount.db')
...
if __name__ == '__main__':
    ...
    get_fundamental(start_date, end_date)

    # get_stockList('meta.db')
